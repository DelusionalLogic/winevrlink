...
static const char *my_hmd_main_settings_section = "driver_vrdriver";
static const char *my_hmd_display_settings_section = "vrdriver_display";
...
vr::EVRInitError MyHMDControllerDeviceDriver::Activate( uint32_t unObjectId )
{
	...
	// of our driver.
	vr::VRProperties()->SetStringProperty( container, vr::Prop_InputProfilePath_String, "{vrdriver}/input/vrdriver_profile.json" );
	...
	DriverLog("MyHMDControllerDeviceDriver::Activate(%d)", unObjectId);
...
bool MyHMDDisplayComponent::ComputeInverseDistortion( HmdVector2_t *pResult, EVREye eEye, uint32_t unChannel, float fU, float fV )
{
	return false;
}
